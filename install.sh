#!/bin/sh
# install.sh — Symlink skillwright to all detected global platforms
#
...
# ---------------------------------------------------------------------------
do_uninstall() {
    printf "\n${BOLD}Uninstalling skillwright symlinks${NC}\n\n"
...
# ---------------------------------------------------------------------------
do_install() {
    printf "\n${BOLD}Skillwright — Symlink Installer${NC}\n\n"
    ...
    printf "    /skillwright <describe your workflow>\n\n"
}
