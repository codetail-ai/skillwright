...
**Version:** 4.0
**Purpose:** Complete guide to exporting skillwright skills for use across all Claude platforms

---

## 🎯 Overview

Skills created by skillwright are optimized for **Claude Code**, but can be exported for use across all Claude platforms:
...
After creating a skill, skillwright will prompt:
